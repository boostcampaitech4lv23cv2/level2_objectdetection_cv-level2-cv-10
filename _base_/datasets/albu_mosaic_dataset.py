...
img_scale = (1024, 1024)
min_size, max_size = 768, 1024
multi_scale = [(x, x) for x in range(min_size, max_size+1, 128)]
...
train_dataset = dict(
    ...
    dataset=dict(
        type=dataset_type,
        ann_file=data_root + 'fold_1_remove_train.json',
...
data = dict(
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'fold_1_val.json',
        img_prefix=data_root,
        classes=classes,
