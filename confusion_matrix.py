...
def main(args):
    ...
    model_config_path = '/opt/ml/baseline/team/' + args.cfg_path
    model_checkpoint_path = '/opt/ml/baseline/mmdetection/work_dirs/' + args.cfg_path[:-3] + '/' + args.chkpoint_path
    model_file_name = '/opt/ml/baseline/mmdetection/work_dirs/' + args.cfg_path[:-3] + '/confusion_matrix.png'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--chkpoint_path', type=str)
